...
package fr.thebrisingers.slotmachinegame.lwjgl3

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration
import fr.thebrisingers.slotmachinegame.SlotMachineGame
...
fun main() {
    ...
    if (StartupHelper.startNewJvmIfRequired())
      return
    Lwjgl3Application(SlotMachineGame(), Lwjgl3ApplicationConfiguration().apply {
        setTitle("SlotMachineGame")
